...
public class PacmanEnemyRed {
	...
	public PacmanEnemyRed(int posEnemyI1, int posEnemyJ1) {
	...
	public static void checkHero() {
		...
		else if (posEnemyI == Pacman.PosHeroI && posEnemyJ == Pacman.PosHeroJ
				&& PacmanField.energizer == true) {
	...
	public void drawEnemy(Graphics g, int x, int y) {
		...
		j1.addPoint(posEnemyJ * y + 8 * size + size / 2, posEnemyI * x + size
				/ 2);
		j1.addPoint(posEnemyJ * y + 9 * size + size / 2, posEnemyI * x + size
				+ size / 2);
		j1.addPoint(posEnemyJ * y + 11 * size, posEnemyI * x + 5 * size + size
				/ 2);
		j1.addPoint(posEnemyJ * y + 11 * size + size / 2, posEnemyI * x + 8
				* size + size / 2);
		j1.addPoint(posEnemyJ * y + size * 11, posEnemyI * x + 12 * size);
		j1.addPoint(posEnemyJ * y + 8 * size, posEnemyI * x + 9 * size);
		j1.addPoint(posEnemyJ * y + 6 * size + size / 2, posEnemyI * x + size
				* 12);
		j1.addPoint(posEnemyJ * y + 5 * size, posEnemyI * x + 9 * size);
		...
		j1.addPoint(posEnemyJ * y + size + size / 2, posEnemyI * x + 5 * size
				+ size / 2);
		j1.addPoint(posEnemyJ * y + size * 3 + size / 2, posEnemyI * x + size
				+ size / 2);
		...
		g.fillOval(posEnemyJ * y + 5 * size, posEnemyI * x + size * 4, 3, 4);
		g.fillOval(posEnemyJ * y + 8 * size, posEnemyI * x + size * 4, 3, 4);
	}
}
