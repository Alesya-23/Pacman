...
public class PacmanEnemyOrange {
	...
	public PacmanEnemyOrange(int posEnemyI1, int posEnemyJ1) {
	...
	public void drawEnemy(Graphics g, int x, int y) {
		...
		j1.addPoint(posEnemyJ * y + 5 * size + size / 2, posEnemyI * x + size
				/ 4);
		...
		j1.addPoint(posEnemyJ * y + 8 * size, posEnemyI * x + 8 * size);
		j1.addPoint(posEnemyJ * y + 6 * size + size / 2, posEnemyI * x + size
				* 12);
		j1.addPoint(posEnemyJ * y + 5 * size, posEnemyI * x + 8 * size);
		...
		j1.addPoint(posEnemyJ * y + size + size / 2, posEnemyI * x + 5 * size
				+ size / 2);
		j1.addPoint(posEnemyJ * y + size * 2, posEnemyI * x + size);
		...
		g.fillOval(posEnemyJ * y + 5 * size + size / 16, posEnemyI * x + size
				* 3 + size / 2 + size / 16, 2, 3);
		g.fillOval(posEnemyJ * y + 8 * size + size / 16, posEnemyI * x + size
				* 3 + size / 2 + size / 16, 2, 3);
